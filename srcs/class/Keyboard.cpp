...
Keyboard::Keyboard() {
    ...
    _actions[1] = (t_key){KEY_SCREENSHOT, MLX_KEY_S, MLX_RELEASE};
    _actions[2] = (t_key){KEY_GENERATE_MAP, MLX_KEY_G, MLX_RELEASE};
    _actions[3] = (t_key){KEY_UP, MLX_KEY_UP, MLX_RELEASE};
    _actions[4] = (t_key){KEY_DOWN, MLX_KEY_DOWN, MLX_RELEASE};
    _actions[5] = (t_key){KEY_LEFT, MLX_KEY_LEFT, MLX_RELEASE};
    _actions[6] = (t_key){KEY_RIGHT, MLX_KEY_RIGHT, MLX_RELEASE};
}
